...
export const Step3: React.FC<Step3Props> = ({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Persist email-verification + firstName to kinship-agent
      await agentApi.post("/visitors/upsert-early-access", {
      ...
      // Non-blocking: continue even if upsert fails — local storage
      // still holds the data and Step 8 will submit everything.
    } finally {
      setIsLoading(false);
    }
