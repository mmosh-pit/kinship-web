const Privacy = () => (
  <div className="flex flex-col items-center tos-container w-full min-h-screen">
    ...
    <p>
      ...
      we will notify you by revising the date at the top of this policy and, in
    ...
    <p>
      When you access or use our Website or otherwise transact business with us,
      we automatically collect certain information, including:
    </p>

    <ul>
      <li>
        <strong>Transactional Information:</strong> When you make a purchase or
        return, we collect information about the transaction, such as product
      ...
      <li>
        ...
        about how you access our Website, including data about the device and
        ...
        Website, such as access times, pages viewed, links clicked, and the page
        you visited before navigating to our Website.
      </li>
      <li>
        <strong>Location Information:</strong> In accordance with your device
        permissions, we may collect information about the precise location of
        your device. You may stop the collection of precise location information
        at any time.
      </li>
      <li>
        <strong>
        ...
        cookies and web beacons, to collect information about you. Cookies are
        small data files stored on your hard drive or in device memory that help
        us improve our Website and your experience, see which areas and features
        of our Website are popular, and count visits. Web beacons (also known as
        "pixel tags" or "clear GIFs") are electronic images that we use on our
        Website and in our emails to help deliver cookies, count visits, and
    ...
    <p>
      ...
      analytics providers, wallet address providers, and mailing list providers
      (if applicable).
    </p>
    ...
    <ul>
      ...
      <li>
        ...
        and others and provide news and information that we think will interest
        you;
      </li>
      <li>
      ...
      <li>
        ...
        deceptive, fraudulent, or illegal activity and protect the rights and
        property of Solana and others;
      </li>
      <li>Debug to identify and repair errors in our Website;</li>
      <li>Comply with our legal and financial obligations; and</li>
      <li>
        Carry out any other purpose described to you at the time the information
        was collected.
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        ...
        negotiations concerning, any merger, sale of company assets, financing,
    ...
    <p>
      ...
      download and install the Browser Plugin available by visiting the
      following location provided:{" "}
    ...
    <p>
      We operate and engage service providers in various jurisdictions.
      ...
      home jurisdiction. By using our site, you acknowledge and agree to such
      transfers and processing, including to and in the United States. We will
      take steps to ensure that your personal information receives an adequate
      level of protection in the jurisdictions in which we process it.
    </p>

    <h2 className="my-4">YOUR CHOICES</h2>

    <h3>Cookies</h3>

    <p>
      Most browsers are set to accept cookies by default. If you prefer, you can
      usually set your browser to disable cookies, or to alert you when cookies
      are being sent. Likewise, most mobile devices allow you to disable the
      ability for geolocation information to be collected from your mobile
      device. The help function on most browsers and mobile devices contains
      instructions on how to set your browser to notify you before accepting
      cookies, disable cookies entirely, or disable the collection of
      geolocation data. You need to set each browser, on each device you use to
      surf the Web. Thus, if you use multiple browsers (e.g., Chrome, Safari,
      Internet Explorer, Firefox, etc.), you should repeat this procedure with
      each one. Similarly, if you connect to the Web from multiple devices
      (e.g., work and home), you need to set each browser on each device.
      Depending on your jurisdiction, you may be able to utilize additional
      cookie management tools. Please note that removing or rejecting cookies
      could affect the availability and functionality of our Website.
    </p>

    <h3>Communications Preferences</h3>

    <p>
      You may opt out of receiving newsletters from us by following the
    ...
    <p>
      ...
      geolocation data. For details about the precise data points we collect and
      the categories of sources of such collection, please see the Collection of
      Information section above. We collect personal information for the
    ...
    <p>
      ...
      Kingdom, or Switzerland, you have certain rights and protections under the
      law regarding the processing of your personal data, and this section
      applies to you.
    </p>
    ...
    <ul>
      ...
      <li>
        ...
        maintain, and improve our products and services, conduct data analytics,
      ...
      <li>
        ...
        processing of your personal data, you may withdraw such consent at any
        time.
      </li>
    </ul>
    ...
    <p>
      ...
      the personal data we hold about you and to receive your data in a portable
    ...
    <p>
      ...
      not able to resolve, you have the right to lodge a complaint with the Data
