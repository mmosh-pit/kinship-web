...
function StepNumber({ n }: { n: number }) {
  return (
    <div className="theme-accent-gradient-bg p-[1.5px] rounded-full shrink-0">
      <div className="w-12 h-12 rounded-full bg-theme-card-from flex items-center justify-center">
        <span className="font-goudy font-bold text-xl theme-accent-gradient-text leading-none pb-[0.05em]">
          {n}
        </span>
      </div>
    </div>
            ...
            return (
              ...
              >
                <div className="theme-card-bg rounded-xl py-7 px-5 h-full flex flex-col items-center text-center">
                  ...
                  {step.title && (
                    <p className="text-theme-heading font-bold text-[1.25rem] font-avenirNext mt-4">
              ...
              <div key={i} className="flex items-start gap-5">
                ...
                <div className="flex-1 pt-1">
                  <div className="flex items-center gap-3">
                    ...
                    {step.title && (
                      <p className="text-theme-heading font-bold text-[1.25rem] font-avenirNext">
                        {renderWithLineBreaks(step.title)}
                      </p>
                    )}
                  </div>
                  {step.description && (
                    <p className="text-theme-muted font-avenir text-[0.938rem] leading-relaxed mt-2">
                      {renderWithLineBreaks(step.description)}
                    </p>
                  )}
                </div>
