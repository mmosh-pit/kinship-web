const TOS = () => {
  return (
    <div className="flex flex-col items-center tos-container w-full min-h-screen">
      ...
      <h2>Last updated October 30, 2024.</h2>
      ...
      <p>
        ...
        Kiduna Club (“Kiduna,” “KC,” “we,” “us” or “our”) concerning use of the
        our services (the “Service”), including this website{" "}
        ...
        For the avoidance of doubt, KMS does not control the Kiduna Protocol
        (“KP”) protocol on which we operate, The Big Kiduna, LLC, Kinship
        Intelligence Institute, Telegram, Gmail, Bluesky or any other systems,
        networks, apps, protocols, devices or platforms on which we might
        appear. KMS cannot control activity and data on KAP, the activities of
        persons who develop and use applications on KAP, the distribution of
        royalties on KAP, or use of KAP. KAP is an open-source protocol that was
        developed and is maintained by KMS. The genesis ecosystem for the KC is
        Kiduna Club. Any third party may develop applications, protocols,
        networks and services that use KAP, so our tokens and other materials
        may appear in various contexts outside our control.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          usernames, email addresses, Telegram accounts, social media accounts,
          and/or wallet addresses of users by electronic or other means for the
          purpose of sending unsolicited messages or tokens, or creating user
        ...
        <li>
          ...
          the Service and/or the content contained therein.
        </li>
        ...
        <li>
          ...
          use the Service and/or the content for any revenue-generating endeavor
        ...
        <li>
          ...
          Service or modifies, impairs, disrupts, alters, or interferes with the
          use, features, functions, operation, or maintenance of the Service.
        </li>
        <li>
        ...
        <li>
          ...
          otherwise harm, in our opinion, us, the Service and/or other users of
          the Service.
        </li>
        <li>
          Copy, reproduce, distribute, publicly perform or publicly display all
          or portions of our Service, except as expressly permitted by us or our
          licensors.
        </li>
        <li>
          Modify our Service, remove any proprietary rights notices or markings,
          or otherwise make any derivative works based upon our Service.
        </li>
        <li>
          Infringe any patent, trademark, trade secret, copyright or other
          intellectual or proprietary right of LHC or any third party.
        </li>
        <li>
      ...
      <p>
        “Kiduna Club” and our logos, our product or service names, our slogans
        and the look and feel of the Service are trademarks of KMS and may not
        be copied, imitated or used, in whole or in part, without our prior
        written permission, which may be obtained by emailing Kiduna Club, our
        technical partners, at support@kiduna.news. All other trademarks,
        registered trademarks, product names and company names or logos
        mentioned on the Service are the property of their respective owners.
      ...
      <p>
        ...
        your claim (“Notice”) to KMS by email at support@kiduna.news or by US
        mail addressed to Kiduna Club, P.O. Box 2085, Shepherdstown, WV 25443.
        ...
        similar in form to that described above. If you and KMS cannot reach an
        agreement to resolve the Dispute within thirty (30) days after such
        Notice is received, then either party may submit the Dispute to binding
        ...
        Arbitration proceedings will be held in Martinsburg, WV. You and KMS
        agree that Disputes will be held in accordance with the JAMS Streamlined
        Arbitration Rules and Procedures (“JAMS Rules”). The most recent version
        of the JAMS Rules are available on the JAMS website and are hereby
        ...
        read the JAMS Rules and waive any claim that the JAMS Rules are unfair
      ...
      <p>
        ...
        otherwise be available in court, including the power to determine the
      ...
      <p>
        ...
        provides to the contrary. The duty of confidentiality does not apply to
      ...
      <p>
        ...
        resolve Disputes in accordance with the governing law and venue terms of
        this EULA.
      </p>
      ...
      <p>
        ...
        this Section or the parties’ ability to compel arbitration of any
        remaining claims on an individual basis pursuant to this Section; and
        ...
        Further, if any part of this Section is found to prohibit an individual
        claim seeking public injunctive relief, that provision will have no
      ...
      <p>
        ...
        POSSIBILITY OF SUCH DAMAGES. YOU AGREE THAT YOUR USE OF THE SITE AND
        SERVICE WILL BE AT YOUR SOLE RISK. THE FOUNDATION IS NOT RESPONSIBLE FOR
        ANY DAMAGES OR LOSSES THAT RESULT FROM YOUR USE OF THE SERVICE,
        INCLUDING, BUT NOT LIMITED TO, YOUR USE OR INABILITY TO USE THE SERVICE;
        ANY CHANGES TO OR INACCESSIBILITY OR TERMINATION OF THE SERVICE; ANY
        DELAY, FAILURE, UNAUTHORIZED ACCESS TO, OR ALTERATION OF ANY
        TRANSMISSION OR DATA; ANY TRANSACTION OR AGREEMENT ENTERED INTO THROUGH
        THE SERVICE; ANY ACTIVITIES OR COMMUNICATIONS OF THIRD PARTIES; OR ANY
        DATA OR MATERIAL FROM A THIRD PERSON ACCESSED ON OR THROUGH THE
      ...
      <p>
        ...
        EULA; (4) your violation of the rights of a third party, including but
        not limited to intellectual property rights; (5) any overt harmful act
        toward any other user of the Service with whom you connected via the
        Service; or (6) any breach of, or failure to comply with, applicable
        law. Notwithstanding the foregoing, we reserve the right, at your
      ...
      <p>
        ...
        airdrop or by making them accessible on the Site or through email
        (including via “hyperlinks” provided online and in emails, direct
        messages or token metadata). We may always, in our sole discretion,
      ...
      <p>
        ...
        by contacting us at support@kiduna.news. We will process your request to
        withdraw your consent to receive electronic Communications in a
      ...
      <p>
        ...
        Communication by contacting us at support@kiduna.news. We may charge you
        fees associated with processing and mailing your request. We will send a
